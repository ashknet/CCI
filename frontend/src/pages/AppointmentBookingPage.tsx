  ...
  const fetchAvailableSlots = async () => {
    try {
      ...
      const response = await axios.get(
        `/api/appointments/doctor/${doctorId}/available-slots?startDate=${startDate}&endDate=${endDate}`
      )
      setAvailableSlots(response.data.data.filter((slot: any) => slot.isAvailable))
    } catch (error) {
