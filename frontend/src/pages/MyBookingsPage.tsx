...
const MyBookingsPage = () => {
  ...
  const fetchBookings = async () => {
    ...
    try {
      if (activeTab === 'appointments') {
        ...
        const response = await axios.get('/api/transport/bookings')
        setTravelBookings(response.data.data)
      } else {
        const response = await axios.get('/api/accommodation/bookings')
        setHotelBookings(response.data.data)
      }
    } catch (error) {
  ...
  const handleCancelAppointment = async (id: string) => {
    ...
    try {
      await axios.patch(`/api/appointments/${id}/cancel`, 'User requested cancellation')
